...
int main (void)
{
    ...
    fichero_particulas.open("/home/cphys-alvaro.zorrillacarriqui/Documentos/leccion1-voluntario/apartado2/modulo_velocidades=3/particles_positions_data.dat");
    fichero_energia.open("/home/cphys-alvaro.zorrillacarriqui/Documentos/leccion1-voluntario/apartado2/modulo_velocidades=3/energy_time_data.dat");
    fichero_velocidades.open("/home/cphys-alvaro.zorrillacarriqui/Documentos/leccion1-voluntario/apartado2/modulo_velocidades=3/velocity_time.dat");
    fichero_resultados.open("/home/cphys-alvaro.zorrillacarriqui/Documentos/leccion1-voluntario/apartado2/modulo_velocidades=3/results.dat");
    ...
    for ( i = 0; i <= n-1; i++)
    {
      ...
      /* Consideramos velocidades iniciales de módulo 2,3 y 4 */
      omega = rand() % 100000;

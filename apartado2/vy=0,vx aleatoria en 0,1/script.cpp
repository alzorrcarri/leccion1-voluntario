...
int main (void)
{
    ...
    fichero_particulas.open("/home/cphys-alvaro.zorrillacarriqui/Documentos/leccion1-voluntario/apartado2/vy=0,vx aleatoria en 0,1/particles_positions_data.dat");
    fichero_energia.open("/home/cphys-alvaro.zorrillacarriqui/Documentos/leccion1-voluntario/apartado2/vy=0,vx aleatoria en 0,1/energy_time_data.dat");
    fichero_velocidades.open("/home/cphys-alvaro.zorrillacarriqui/Documentos/leccion1-voluntario/apartado2/vy=0,vx aleatoria en 0,1/velocity_time.dat");
    fichero_resultados.open("/home/cphys-alvaro.zorrillacarriqui/Documentos/leccion1-voluntario/apartado2/vy=0,vx aleatoria en 0,1/results.dat");
    ...
    for ( i = 0; i <= n-1; i++)
    {
      ...
      /* Consideramos velocidades iniciales con la dirección solo en el eje x positivo */
      vx[i] = rand() % 100000;
      vx[i] = vx[i] / 100000.0;
      vy[i] = 0;
   ...
   for ( k = 0; k < 30000; k++)
   {
    ...
    temp=temp/(30.0/h);
    fichero_resultados << "Temperatura del sistema estimada por el teorema de equipartición:" << '\t' << temp <<'\n';
